...
x,y = np.meshgrid(np.linspace(0,340,35),np.linspace(1,128,128))
...
plt.plot(np.linspace(0,340,35), ADC[82,:], label="Measured counts")
plt.xlim(80,350)
plt.vlines(120, ymin=0, ymax=140, label = "Start of Peak", color = "red", linestyle = "dashed")
plt.vlines(170, ymin=0, ymax=140, label = "Maximum", color = "green", linestyle = "dashed") 
plt.vlines(220, ymin=0, ymax=140, label = "End of Peak", color = "red", linestyle = "dashdot")
plt.vlines(240, ymin=0, ymax=140, color = "red", linestyle = "dashed")
plt.vlines(290, ymin=0, ymax=140, color = "green", linestyle = "dashed") 
plt.vlines(340, ymin=0, ymax=140, color = "red", linestyle = "dashdot")
plt.xlabel(r'Distance / $\mu$m')
plt.ylabel(r'ADC counts')
plt.grid()
plt.legend(loc='best')
...
plt.bar(np.linspace(0,127,128), no_clusters)
#plt.yscale("log")
plt.xlim(-0.8,5)
...
plt.bar(np.linspace(0,127,128), no_channels)
#plt.yscale("log")
plt.xlim(0,8)
