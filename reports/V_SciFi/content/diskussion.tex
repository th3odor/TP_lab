...
The maximum angles in the angular distribution, shown in \autoref{fig:anglesmantlecore} are in agreement with the calculated ones, with only a minimal shift. \\ %LINEARER ANSTIEG
