...
The intensity also seems to increase linearly with the angle until total refelction is reached. This is expected, as the reflected intensity is proportional to $\sin(\theta)$ as the photons are created  %will be lower if the production angle deviates from the total reflection angle.\\
